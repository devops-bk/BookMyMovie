...
class Movie:
    ...
    def buy_ticket(self, row, seats):
        ...
        if s_seat_no in number:
            print("Seat already booked! Kindly see the arrangement and book an unreserved seat!")
            seat_status = "Booked"
                ...
                if ans == "yes":
                    ...
                    while True:
                        ...
                        if age not in range(1, 101):
                            print("Invalid age ! Age should be between 1-100")
                            continue
                        break
                    ...
                    while True:
                        ...
                        if not x:
                            print("Invalid Phone Number ! Please enter 10 digit number starting with 7,8 or 9")
                            continue
                        break
